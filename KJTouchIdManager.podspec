#
#  Be sure to run `pod spec lint KJTouchIdManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Smiacter"
  # s.authors            = { "Smiacter" => "Smiacter@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Smiacter"
